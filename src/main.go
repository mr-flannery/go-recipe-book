...
import (
	...
	"github.com/mr-flannery/go-recipe-book/src/internal/handlers"
	"github.com/mr-flannery/go-recipe-book/src/internal/models"
...
func importHandlersHome(w http.ResponseWriter, r *http.Request) {
	...
	// This import path assumes your module name is github.com/mr-flannery/go-recipe-book/src
	// Adjust the import path if your module name is different
	//
	// import "github.com/mr-flannery/go-recipe-book/src/internal/handlers"
	// handlers.Home(w, r)
